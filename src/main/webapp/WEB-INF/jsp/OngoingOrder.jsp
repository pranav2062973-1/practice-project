...
%>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto mr-5">
				...
				<li class="nav-item active"><a class="nav-link mr-4" href="#">Live Delivery</a></li>
	...
	<%
		if(list.isEmpty()) {
	%>
		<h1 class="text-center">No Ongoing Orders to show</h1>
	<% } else { %>
			...
			<tbody>
				...
				<%
					for(OrderData order: list)
					{
						...
						<td><a href="PartnerComplete/<%= order.getOrderDataId() %>" class="btn btn-primary">Complete</a></td>
						</tr>
				<% 
					}
				%>

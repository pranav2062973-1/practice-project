	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto mr-5">
				...
				<li class="nav-item"><a class="nav-link mr-4" href="LiveOrders">Live
						Orders</a></li>
		...
		<table class="table table-bordered text-center">
			...
			<tbody>
					...
					for(OrderData order: list)
					{
						...
						<td>
							<a href="HotelAccept/<%=order.getOrderDataId() %>" class="btn btn-success">Accept</a>
							<a href="HotelReject/<%=order.getOrderDataId() %>" class="btn btn-danger">Reject</a>
						</td>

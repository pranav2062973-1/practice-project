...
<%
	List<?> orderList = (List<?>) request.getAttribute("hotelList");
...
%>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto mr-5">
				<li class="nav-item mr-4"><a class="nav-link" href="HotelIndex">Home</a>
				</li>
				<li class="nav-item active"><a class="nav-link mr-4" href="LiveOrders">Live
						Orders</a></li>
				<li class="nav-item"><a class="nav-link mr-4" href="HotelHistory">History</a>
				</li>
	...
	<div class="container pt-5">
		...
		if(list.isEmpty()) {
	%>
		<h1 class="text-center">No pending orders to show</h1>
	<% } else { %>
		...
		<table class="table table-bordered text-center">
			...
			<tbody>
					...
					for(OrderData order: list)
					{
						...
						<td>
							<a href="HotelComplete/<%=order.getOrderDataId() %>" class="btn btn-primary">Complete</a>
						</td>

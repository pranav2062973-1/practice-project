...
<%
	List<?> orderList = (List<?>) request.getAttribute("TrackList");
...
%>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto mr-5">
				<li class="nav-item mr-4"><a class="nav-link" href="UserIndex">Home</a>
				</li>
				<li class="nav-item active"><a class="nav-link mr-4" href="#">Track
						Order</a></li>
	...
	<%
		if(list.isEmpty()) {
	%>
		<h1 class="text-center">No ongoing orders to track</h1>
	<% } else { %>

		<h2 class="text-center">Track Orders</h2>

...
%>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto mr-5">
				...
				<li class="nav-item"><a class="nav-link mr-4" href="OngoingOrder">Live
						Delivery</a></li>
				<li class="nav-item"><a class="nav-link mr-4" href="PartnerHistory">History</a>
				</li>
	...
	<%
		if(list.isEmpty()) {
	%>
		<h1 class="text-center">No Orders to show</h1>
	<% } else { %>
			...
			<tbody>
				...
				<%
					for(OrderData order: list)
					{
						...
						<td>
							<a href="PartnerAccept/<%= order.getOrderDataId() %>" class="btn btn-success">Accept</a>
							<a href="PartnerReject/<%= order.getOrderDataId() %>" class="btn btn-danger">Reject</a>
						</td>
						</tr>
				<% 
					}
